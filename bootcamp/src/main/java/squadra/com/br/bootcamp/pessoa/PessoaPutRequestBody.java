...
import lombok.Data;
import squadra.com.br.bootcamp.endereco.EnderecoPutRequestBody;
...
public class PessoaPutRequestBody {
    ...
    @NotNull(message = "o campo endereços deve não pode ser nulo")
    @NotEmpty(message = "o campo endereços deve possuir pelo menos um endereço")
    private List<EnderecoPutRequestBody> enderecos;
}
